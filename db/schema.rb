...
ActiveRecord::Schema.define(version: 20200605094118) do
  ...
  create_table "imports", force: :cascade do |t|
    ...
    t.datetime "updated_at",              null: false
    t.string   "type"
    t.index ["account_id"], name: "index_imports_on_account_id", using: :btree
  ...
  create_table "subsystem_tags", force: :cascade do |t|
    t.string   "name"
    t.string   "description"
    t.integer  "account_id"
    t.datetime "deleted_at"
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["account_id"], name: "index_subsystem_tags_on_account_id", using: :btree
    t.index ["deleted_at"], name: "index_subsystem_tags_on_deleted_at", using: :btree
  end
  ...
  create_table "versions", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.integer  "account_id"
    t.index ["account_id"], name: "index_versions_on_account_id", using: :btree
