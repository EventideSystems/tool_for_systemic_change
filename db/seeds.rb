...
sdgs_goals_and_targets = ImpactCardDataModel.where(system_model: true).find_by(name: 'SDGs Goals and Targets') 

if sdgs_goals_and_targets.nil?
  sdgs_goals_and_targets = ImpactCardDataModel.create!(
