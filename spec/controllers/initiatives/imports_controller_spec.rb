...
RSpec.describe Initiatives::ImportsController, type: :controller do
  ...
  # Initiatives::ImportsController. Be sure to keep this updated too.
  let(:valid_session) { {} }

  describe "GET #index" do
    it "assigns all initiatives_imports as @initiatives_imports" do
      import = Initiatives::Import.create! valid_attributes
      get :index, params: {}, session: valid_session
      expect(assigns(:initiatives_imports)).to eq([import])
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested initiatives_import" do
      import = Initiatives::Import.create! valid_attributes
      expect {
    ...
    it "redirects to the initiatives_imports list" do
      import = Initiatives::Import.create! valid_attributes
      delete :destroy, params: {id: import.to_param}, session: valid_session
      expect(response).to redirect_to(initiatives_imports_url)
    end
  end
